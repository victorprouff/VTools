...
Et, pour moi, rester sur X, ça devient de la complicité.", new List<string> { "https://eventuallycoding.com/2025/01/bye-twitter" }, Category.Articles),
            ...
            Article.Create("Cyberattaque contre E.Leclerc\u00a0: des données personnelles «\u00a0ont pu être exposées\u00a0»", "", new List<string> { "https://next.ink/167199/cyberattaque-contre-e-leclerc-des-donnees-personnelles-ont-pu-etre-exposees/", "" }, Category.Articles),
